...
- Automated tests run under vitest: `npm test`, or `npm run test:watch`.
- Parsing and serialisation logic must be testable without launching Obsidian,
  which is why `src/parse/` imports nothing from `obsidian`.
